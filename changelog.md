...
Implemented the main XML theme file [`nord.xml`](https://github.com/nordtheme/notepadplusplus/blob/develop/src/xml/nord.xml). (@svengreb, #1, 81e80e6b)
...
Detailed information about supported languages and install instructions can be found in the [README](https://github.com/nordtheme/notepadplusplus/blob/develop/readme.md#installation).
